...
\usepackage{enumitem}        % For customizing lists (bullet points, etc.)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Package Settings
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Adjust the left padding for bullet points
\setlist[itemize]{left=0pt}  % Removes default left padding for itemize
...
\titlespacing*{\chapter}{0pt}{-25pt}{10pt}  % 0pt left space, 0pt top space, 10pt space after title
...
\newcommand{\key}[1]{%
  \fbox{\raisebox{0pt}[0.8em][0.2em]{\textsf{#1}}}%
}
